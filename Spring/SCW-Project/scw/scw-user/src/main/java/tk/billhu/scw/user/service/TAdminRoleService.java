...
public interface TAdminRoleService {
    ...
    List<AdminRoleResponseVo> getAssignedRole(int adminid);

    List<AdminRoleResponseVo> getUnAssignedRole(int adminid);

    String assignAdminRoles(String adminId, String roleIds);
}
