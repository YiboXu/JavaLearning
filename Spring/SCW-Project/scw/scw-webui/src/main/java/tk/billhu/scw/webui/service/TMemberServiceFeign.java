...
public interface TMemberServiceFeign {
    ...
    @GetMapping("/admin/permission/all")
    AppResponse<List<AdminPermissionVo>> getAllPermission();

    @GetMapping("/admin/permission/getAdminPermission")
    AppResponse<AdminPermissionVo> getAdminPermission(@RequestParam("id") String id);

    @PostMapping("/admin/permission/createAdminPermission")
    AppResponse<String> addAdminPermission(@RequestBody AdminPermissionRegisterVo adminPermissionRegisterVo);

    @PostMapping("/admin/permission/updateAdminPermission")
    AppResponse<String> updateAdminPermission(@RequestBody AdminPermissionUpdateVo adminPermissionUpdateVo);

    @PostMapping("/admin/permission/deleteAdminPermission")
    AppResponse<String> deleteAdminPermission(@RequestParam("id") String id);

    @GetMapping("/admin/role/getAssignedRole")
    AppResponse<List<AdminRoleResponseVo>> getAssignedRole(@RequestParam(value="adminid") String adminid);

    @GetMapping("/admin/role/getUnAssignedRole")
    AppResponse<List<AdminRoleResponseVo>> getUnAssignedRole(@RequestParam(value="adminid") String adminid);

    @PostMapping("/admin/role/assignAdminRoles")
    AppResponse<String> assignAdminRoles(@RequestParam(value="adminId") String adminId, @RequestParam(value="roleIds") String roleIds);

    @PostMapping("/admin/permission/assignRolePermissions")
    ...
    @GetMapping("/admin/permission/getPermissionByRoleId")
