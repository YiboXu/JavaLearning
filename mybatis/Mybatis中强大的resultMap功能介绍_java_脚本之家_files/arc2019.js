...
var aliyun1000='';
aliyun1000 += '<div class="mainlr"><a href="http://click.aliyun.com/m/1000082213/" target="_blank"><img src="//files.jb51.net/image/aliyun1200.png?1031" alt="aliyun"></a></div><div class="blank5"></div>';
...
idctu+='<div class="blank5"></div><A href="https://www.aliyun.com/1111/2019/group-buying-share?ptCode=455074420DA730506170E3C9775E137B647C88CF896EF535&userCode=txzd1w9g&share_source=copy_link" target=_blank><IMG alt="" src="//files.jb51.net/image/hoenen.png?1027" width="300" height="100"></A>';
...
idctu+='<div class="blank5"></div><A href="http://click.aliyun.com/m/1000082215/" target=_blank><IMG alt="" src="//files.jb51.net/image/aliyun300.png?1031" width="300" height="100"></A>';
...
tgtxt+='<li><a href="http://click.aliyun.com/m/1000082214/" target="_blank"><span style="color:red;">【阿里云双11】亿元补贴-爆款产品一折起</span></a></li>';
...
tgtxt+='<li><a href="https://cloud.tencent.com/act/cps/redirect?redirect=1048&cps_key=a9fc1fd02d02458c07d0768af804b84c&from=console" target="_blank"><span style="color:blue;">【腾讯云双11】企业3年688元</span></a></li>';
...
tgtxt+='<li><a href="https://www.beianidc.com/huodong/" target="_blank"><span style="color:red;">██机房直销██每月半价抢购</span></a></li>';
...
tonglan1+='<li><A href="https://www.1dyun.com/host/" target=_blank><IMG alt="" src="//files.jb51.net/image/1dyun.gif?1029"></A></li>';
...
tonglan1+='<li><A href="https://www.zmera.com/page195" target=_blank><IMG alt="" src="//files.jb51.net/image/zmera235.gif?1018"></A></li>';
...
if("undefined" != typeof lmname){
	if(lmname == "python"){
	art_wxz+='<a href="http://www.xz577.com/" target="_blank"><img src="//files.jb51.net/image/tb_all.gif?1012" class="nohref"></a>';
	}else if(lmname == "java"){
	art_wxz+='<a href="http://www.xz577.com/" target="_blank"><img src="//files.jb51.net/image/tb_all.gif?1012" class="nohref"></a>';
	}else if (lmname != "")
	{
...
if($addnr){
	if(projectName=="article"){
		...
		$addnr.before('<div style="padding: 10px 0 20px 0;color:red;font-weight:bold;">如对本文有所疑义或者对本文内容提供补充建议，请联系小编<a href="http://wpa.qq.com/msgrd?v=3&uin='+ xbqq +'&site=jb51net&menu=yes" target="_blank"><img border="0" src="https://pub.idqqimg.com/qconn/wpa/button/button_111.gif" alt="点击这里给我发消息" title="点击这里给我发消息"/></a>，本站会保留修改者版权</div>');
}
